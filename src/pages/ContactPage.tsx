      ...
      <div className="col-span-12 space-y-8 px-[10dvw] py-24 md:col-span-7">
        ...
        <div className="grid grid-cols-12 space-x-8">
          <div className="col-span-5 space-y-4">
            <div className="font-sans-black text-lg text-sunset">Phone</div>
            <div className="text-sm">9899654321</div>
          </div>
          <div className="col-span-7 space-y-4">
            <div className="font-sans-black text-lg text-sunset">Location</div>
            <div className="text-sm">FF Main Street, 22nd Avenue</div>
          </div>
        </div>
        <div className="grid grid-cols-12 space-x-8">
          <div className="col-span-5 space-y-4">
            <div className="font-sans-black text-lg text-sunset">Email</div>
            <div className="text-sm">saanjh@gmail.com</div>
          </div>
          <div className="col-span-7 space-y-4">
            <div className="font-sans-black text-lg text-sunset">Follow Us</div>
