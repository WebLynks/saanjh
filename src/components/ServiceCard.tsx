  ...
  return (
    <div className="col-span-3 md:col-span-1">
      <div className={`rounded-lg shadow-sm shadow-${bgColor}`}>
        ...
        >
          <div className="font-sans-black h-full space-y-2 overflow-hidden py-4 text-xl text-white">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-4 md:max-lg:flex-col md:max-lg:items-start">
          ...
          <div className="font-sans-black flex flex-col items-end justify-end md:max-lg:items-start">
            {name.split(" ").map((word) => (
